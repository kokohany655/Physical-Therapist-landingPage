...
const Footer = () => {
  return (
    <div className=" w-full  flex justify-center items-center   md:p-16 px-5 py-8 footer">
      <div className="container grid md:grid-cols-3 grid-cols-1 justify-start items-start md:gap-40 gap-20">
        <div className=" space-y-8">
          <p className=" border-b-4 border-primary py-2 text-xl w-24">
            About me
          </p>
          <p className=" text-xl">
            I have a strong relationship for this line of work and constantly
            seek to improve my abilities
          </p>
        </div>
        <div className="  space-y-8">
          <p className=" border-b-4 border-primary py-2 text-xl w-28">
            Contact Me
          </p>
          <div className="flex flex-col justify-start items-start gap-3">
            ...
            <div className=" flex justify-center items-center gap-2">
              ...
              >
                <path
                  d="M18.9 0H2.1C0.945 0 0.0105 0.95625 0.0105 2.125L0 14.875C0 16.0438 0.945 17 2.1 17H18.9C20.055 17 21 16.0438 21 14.875V2.125C21 0.95625 20.055 0 18.9 0ZM18.9 4.25L10.5 9.5625L2.1 4.25V2.125L10.5 7.4375L18.9 2.125V4.25Z"
                  fill="#358E9C"
                />
              </svg>
          ...
          <div className="flex flex-col justify-start items-start gap-3">
            <div className=" flex items-center justify-center gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" width="10" height="16" viewBox="0 0 10 16" fill="none">
                        <path d="M2 2L8 8L2 14" stroke="#358E9C" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round"/>
                    </svg>
                    <Link href={"#home"}>
